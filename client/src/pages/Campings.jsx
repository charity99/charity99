...
const ServiceAll = () => {
  ...
  const currentBenefices = formData.slice(
  ...
  const filteredBenefices = formData.filter((benefice) =>
    benefice.fullName.toLowerCase().includes(searchTerm.toLowerCase())
  );
    ...
    <>
            ...
            <div className="flex flex-col items-center justify-between xl:flex-row">
              <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                  ساعد محتاج الان <br className="hidden md:block" />
                </h2>
      ...
      <div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-center">
                    ...
                    <Link
                      ...
                      className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent mt-4 rounded transition-colors duration-300"
                    >
                      التفاصيل
                    </Link>
                    {/* </Link> */}
        ...
        <div className="flex justify-center">
          <Pagination
            count={Math.ceil(
              filteredBeneficesWithFilters.length / beneficesPerPage
            )}
            page={currentPage}
