...
const ProfilePage = () => { 
        ...
        <>
            <div className="p-16 bg-white mt-20 mb-8">
                <h1 className="text-2xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#1a73e8] to-[#8dbbd0] uppercase">صفحتي الشخصية</span>
      ...
      <div class="overflow-hidden">
        <table class="min-w-full text-right text-sm font-light">
            ...
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap px-6 py-4 font-medium">الاسم </td>
              <td class="whitespace-nowrap px-6 py-4">{user}</td>
        
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap px-6 py-4 font-medium">البريد الالكتروني</td>
              <td class="whitespace-nowrap px-6 py-4">{email}</td>
             
            </tr>
            <tr class="border-b dark:border-neutral-500">
              <td class="whitespace-nowrap px-6 py-4 font-medium">الرقم السري</td>
  ...
  تعديل المعلومات الشخصية 
                ...
                <h1 className="text-2xl font-bold text-gray-900 leading-tight mb-2 pb-4 relative">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#1a73e8] to-[#8dbbd0] uppercase"> الطلب الحالي:  </span>
                    <span className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-[#1a73e8] to-[#8dbbd0] uppercase"></span>
                </h1>
...
{/* {prevOrders?.map((order) => { */}
  ...
  نوع التبرع                                                 </h3>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        <p className="text-sm font-medium text-gray-500">
تم تجميع مبلغ                            <span className="text-black">
