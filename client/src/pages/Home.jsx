  ...
  return (
    ...
    <>
      <section className="relative h-screen mt-16 flex flex-col items-center justify-center text-center text-white ">
        ...
        <div className="video-content space-y-2 z-10 pb-5" style={{ height: "10vh" }}>
          <h1 className="font-bold text-5xl text-white mb-16 uppercase text-blue-600">المنصة الاولى لجمع التبرعات للرعاية الصحية
          </h1>
          <h3 className="font-bold text-2xl capitalize ">جمع التبرعات من اجل  تمويل العلاج الطبي. يهمنا دعمكم </h3>
        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="mb-2 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white capitalize text-right">
              تبرع الان .. دعمك يهمنا         </h2>
            <br />

            <p className="mb-4 text-right text-2xl font-bold">

              هدفنا الرئيسي هو جمع التمويل لتحسين خدمات الرعاية الصحية، وتعزيز البنية التحتية الطبية، وتعزيز المبادرات الصحية العامة في الأردن. من خلال توحيد الأفراد الرحيمين مثلك، يمكننا أن نحقق تغييرًا إيجابيًا ونضمن مستقبلًا أكثر صحة للجميع.
...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="rounded-t-lg w-full h-80" src="https://i.pinimg.com/236x/02/e9/2e/02e92ecb5aea13452a89c8a20ae2928b.jpg" alt="" />
    </a>
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> سارة ابراهيم</h5>
        </a>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
               
        انا سارة وقد كنت اعاني من سرطان نادر يحتاج إلى علاج مكلف ومتخصص في الخارج. كانت العائلة غير قادرة على تحمل تكاليف العلاج والسفر. فقررنا التواصل مع موقع ينتمي لانشاء حملة لجمع التبرعات، في غضون اسابيع قليلة تم تجاوز هدف التمويل بشكل واستطعت ان اذهب للعلاج وها انا ذا اتحذث لكم عن تجربتي. شكرا انت تنتمي  </p>
      ...
      <li>
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">فاطمة خليل </h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        
                أنا فاطمة، وأعاني من مرض السكري. لم أتمكن من تحمل تكاليف العلاج والأدوية. اشتركت مع موقع انت تنتمي لاقامة حملة لجمع التبرعات وتلقيت دعمًا كبيرًا. بفضل انت تنتمي تمكنت من الحصول على العلاج اللازم وتحسين حالتي الصحية. أشكر كل من ساهم في حملتي وأدعو لمساعدة المرضى الآخرين في حاجة للرعاية الصحية.  </p>
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">احمد ناجح</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        أنا أحمد، تمكنت من تجاوز مشكلة صحية خطيرة بفضل جمع التبرعات من موقع انت تنتمي. بفضل سخاء الناس، تم تمويل العملية الجراحية اللازمة وتحقيق الشفاء. أشكر كل من ساهم ودعمني، وأؤمن بقوة جمع التبرعات في تحقيق معجزات الشفاء شكرا انت  تنتمي وكل القائمين عليه   واحب شكر جميع لذين ساعدوني في تحقيق طموحي </p>
